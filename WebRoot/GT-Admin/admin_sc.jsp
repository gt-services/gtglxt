...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="getsecond.action" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
       ...
       <tbody>
            ...
            <tr>
            	...
            	<td><a href="editsecond.action?uuid=<s:property value="uuid"/>" class="btn btn-green" data-toggle="dialog" data-width="900" data-height="250" data-id="dialog-mask" >编辑</a>&nbsp;&nbsp;
            	<a class="btn btn-red" id="delete<s:property value="uuid" />" onclick="deleteSecond('<s:property value="uuid" />')">删除</a></td>
            </tr>
            </s:iterator >
            </s:else>
        </tbody>
