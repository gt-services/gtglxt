    ...
    <form action="addroster.action" class="pageForm" id="form" data-toggle="validate">
        ...
        <div class="pageFormContent" data-layout-h="0">
            <table class="table table-condensed table-hover" width="100%">
                ...
                <tr><td><label class='control-label x85'>合同开始日期:</label><input type='text' data-toggle="datepicker" name='roster.htStart'  size='20'  value='<s:date name="roster.htStart" format="yyyy-MM-dd"/>'   readonly="readonly"></td>
                    <td><label class='control-label x85'>合同结束日期:</label><input type='text' data-toggle="datepicker" name='roster.htEnd'  size='20'   value='<s:date name="roster.htEnd" format="yyyy-MM-dd"/>'  ></td></tr>
