...
<div class="bjui-pageContent tableContent">
    <form action="importRoster.action" method="post" id="myfrom" enctype="multipart/form-data">
        <table class="table table-condensed table-hover" width="100%">
            <tbody>
                <tr><td><label class='control-label x85'>模板下载：</label><a href="excel/gt_roster_demo.xls">点击下载表格模板</a></td></tr>
...
<script type="text/javascript">
  	function importExcel(){  
	    ...
	    if(excelPath == null || excelPath == ''){  
	        ...
	        if(fileExtend == '.xls'){
	        	 $.ajaxFileUpload({    
	                 url:'importRoster.action', //url自己写   
	                 ...
	                 success:function(data,status) {
	                	 ...
	                	 if(obj.statusCode == 200){
	                		 ...
	                		 $(this).alertmsg('error', "导入失败！请检查导入表第"+(obj.error+2)+"行！", {displayMode:'slide', displayPosition:'topcenter', title:'提示信息'});
	                		 setTimeout(function(){
	 	             	    	 $("#queryRS").click();
	 	                    },500);
	                	 }
	                 ...
	                 error:function(data,status){
	                	 $(this).alertmsg('error', "导入失败！请检查身份证信息。", {displayMode:'slide', displayPosition:'topcenter', title:'提示信息'})
	                 }
	             });    
