        ...
        <div class="pageFormContent" data-layout-h="0">
            <table class="table table-condensed table-hover" width="100%">
                ...
                <tr><td><label class='control-label x85'>保险类型:</label><input type='text'  name='roster.bxType'  size='20'  value='<s:property value="roster.bxType" />'  ></td>
                    <td><label class='control-label x85'>离厂日期:</label><input type='text' data-toggle="datepicker" name='roster.lcTime'  size='20'   value='<s:date name="roster.lcTime" format="yyyy-MM-dd"/>' ></td></tr>
