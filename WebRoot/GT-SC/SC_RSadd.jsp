        ...
        <div class="pageFormContent" data-layout-h="0">
            <table class="table table-condensed table-hover" width="100%">
                ...
                <tr><td><label  class='control-label x85' >合同编号:</label><input type='text' id="htNumber" name='roster.htNumber'  size='20'  value='<s:property value="roster.htNumber" />'  readonly="readonly"></td>
                    <td><label  class='control-label x85'>姓名:</label><input data-rule="本项:required" type='text' id="name" data-rule="姓名:required"  name='roster.name'  size='20'   value='<s:property value="roster.name" />'  ></td></tr>
                <tr><td><label  class='control-label x85'>性别:</label>
                    <select data-rule="本项:required" data-toggle="selectpicker"  name='roster.sex'  data-width="50"  value='<s:property value="roster.sex" />'  >
                ...
                <tr><td><label class='control-label x85'>保险编号:</label><input  data-rule="本项:required" type='text'  name='roster.sbNumber'  size='20'  value='<s:property value="roster.sbNumber" />'  ></td>
                    <td><label class='control-label x85'>家庭住址:</label><input data-rule="本项:required" type='text' name='roster.address'  size='20'   value='<s:property value="roster.address" />'  ></td></tr>
                <tr><td><label class='control-label x85'>合同开始日期:</label><input data-rule="本项:required" type='text' data-toggle="datepicker" name='roster.htStart'  size='20'  value='<s:date name="roster.htStart" format="yyyy-MM-dd"/>'  ></td>
                ...
                <tr><td colspan="1"><label  class='control-label x85'>工伤处理情况:</label>
                    <select data-rule="本项:required" data-toggle="selectpicker"  name='roster.gsqk'  data-width="80"  value='<s:property value="roster.gsqk" />'  >
