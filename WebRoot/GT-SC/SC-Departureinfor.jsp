...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <%--&lt;%&ndash;<span style="float:right;margin-right:5px;"><a href="/GT-RS/RSimport.jsp" class="btn btn-blue" data-toggle="dialog" data-width="300" data-height="300" data-icon="arrow-up">导入</a></span>&ndash;%&gt;--%>
