...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="getPxInfoList.action?pageType=3" method="post">
     ...
     <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
       ...
       <tbody>
            ...
            <tr>
            	...
            	<td><s:date name="dueToDate" format="yyyy-MM-dd"/></td>
            	<td><a href="editPxInfo.action?type=3&uuid=<s:property value="uuid"/>" class="btn-blue" data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" >详细</a></td>
            	...
            	<a class="btn btn-red" onclick="queryPX('<s:property value="uuid" />')">删除</a></td>
            </tr>
            </s:iterator >
            </s:else>
        </tbody>
...
<script type="text/javascript">
	function queryPX(uuid){
		...
		$(this).alertmsg('confirm', '确定要导出吗？', {displayMode:'slide', displayPosition:'topcenter', okName:'确定', cancelName:'取消', title:'提示信息',okCall:function(){
			  location.href="exportPxInfo.action?exportType=1";
	   }});
	}
