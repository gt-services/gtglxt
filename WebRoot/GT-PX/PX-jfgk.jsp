...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="getPxInfoList.action?pageType=2" method="post">
     ...
     <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
       ...
       <tbody>
            ...
            <tr>
            	...
            	<td><s:property value="payCost"/></td>
...
/* 			$.ajax({
         ...
         location.href="exportPxInfo.action";
	   }});
	}
