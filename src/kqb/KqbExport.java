...
public class KqbExport {
    ...
    private Date createDate; //该数据创建时间
	...
	public String getJobOrSizeName() {
		return jobOrSizeName;
	}

	public void setJobOrSizeName(String jobOrSizeName) {
		this.jobOrSizeName = jobOrSizeName;
	}
