...
//	private String cqday;//出勤天数
//	private String allhous;//工时
	private String monthcount;//月考勤统计
	//以下为新增模块---------扣款(还款)模块
...
/*	public String getCqday() {
	...
	public String getAllhous() {
		return allhous;
	}
	public void setAllhous(String allhous) {
		this.allhous = allhous;
	}*/
